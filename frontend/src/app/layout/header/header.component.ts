...
@Component({
  ...
  template: `
    <header
      class="fixed top-0 left-0 w-full z-10 p-2 bg-dark-blue-600 bg-opacity-85 border-b-2 border-gray-800"
    >
      <nav class="px-4 lg:px-6 py-2.5 text-white">
        ...
        >
          <div class="flex items-center">
            <a
              href="/"
              class="flex items-center py-2 pr-4 pl-3 border-b border-gray-500
            ...
            >
              <img
                src="../assets/logoAula.png"
                class="rounded-full mr-3 h-6 sm:h-9"
                alt="Logo"
              />
              <span
          ...
          <div class="flex items-center lg:order-2">
            ...
            <div class="relative w-full group">
              <button
                class="py-2.5 px-3 w-full md:text-sm text-site bg-transparent peer
              ...
              <div
                class=" absolute z-[99] top-[100%] left-[50%] translate-x-[-50%] rounded-md overflow-hidden shadow-lg
              ...
              >
                <div
                  class="w-full block cursor-pointer hover:bg-dark-blue-900 px-3 py-2 rounded-md"
                >
                  <a
                    routerLink="/perfil"
            ...
            <button
              ...
              hover:bg-dark-blue-500 focus:outline-none"
              aria-expanded="false"
          ...
          <div
            ...
            class="justify-between items-center w-full lg:flex
