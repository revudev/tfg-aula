    ...
    <div class="bg-image">
      <div class="w-full pt-20 mx-auto bg-blue-200 md:max-w-4xl">
        <div class="w-full px-4 text-xl leading-normal text-gray-800 md:px-6">
          ...
          <br />La iniciativa emprendedora supone la capacidad de convertir una
          idea en una realidad utilizando imaginación e ingenio (creatividad)
          para hacer algo nuevo o algo que ya existe, pero con alguna
          modificación (innovación), y siempre asumiendo el riesgo de las
          decisiones. Una persona emprendedora ve oportunidades donde otros ven
          problemas. <br /><br />Debido a los continuos cambios que se producen
          en nuestra sociedad, la creatividad y la innovación son las
          características que diferencian una iniciativa emprendedora de éxito
          de otra condenada al fracaso. <br /><br />Podemos definir la
          iniciativa emprendedora como la capacidad para hacer realidad una idea
          innovadora, es decir, emprender es transformar una idea en un proyecto
          concreto, generando algún beneficio. <br /><br />
          <p>
            Surge con la identificación de una oportunidad y la capacidad para
            explotarla con una idea de negocio, que debe cumplir ciertos
          ...
          <ul class="pl-5 mb-3 list-disc">
            ...
            <li>
              Ser técnicamente posible, es decir, se puede llevar a cabo con los
          ...
          <blockquote
            class="pl-4 my-8 italic border-l-4 border-green-500 md:pl-5"
          >
